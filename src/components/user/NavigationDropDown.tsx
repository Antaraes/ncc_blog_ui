        ...
        {activeMenu !== null ? (
          ...
          <ul className="py-2 text-black">
            {formattedCategories.map((category: any, index: number) => (
              ...
              >
                <div
                  className="flex rounded-md p-2 cursor-pointer hover:bg-secondary text-sm items-center gap-x-4"
                  onClick={() =>
                    handleMenuClick({
                      id: category.id,
                      name: category.name,
      ...
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[500px] gap-3 p-4 md:w-[700px] md:grid-cols-4 lg:w-[800px]">
                        ...
                        {category.subCategories &&
                          category.subCategories.map((subCategory: any) => (
                            <Link
                              ...
                              passHref
                            >
                              <p className="hover:text-black hover:font-bold mt-2">
                                {subCategory.name}
                              </p>
                            </Link>
                          ))}
